...
/// <summary>
/// 튜닝 저작 SO. 인스펙터 항목 = design 표 항목.
/// 노출하지 않은 세부값은 CreateStandard 기본을 따른다.
/// </summary>
[CreateAssetMenu(fileName = "DungeonCafeTuning", menuName = "DungeonCafe/Tuning")]
public sealed class DungeonCafeTuningSO : ScriptableObject
{
    [Header("게이지 (§1/§3)")]
    ...
    public DungeonCafeTuning BuildTuning()
    {
        DungeonCafeTuning std = DungeonCafeTuning.CreateStandard();
        return new DungeonCafeTuning(
