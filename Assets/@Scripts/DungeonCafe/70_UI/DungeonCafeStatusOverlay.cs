...
public sealed class DungeonCafeStatusOverlay : UIOverlay<DungeonCafeStatusOverlay.Refs>
{
    ...
    private void ApplyProgress(in DungeonCafeHudSnapshot snapshot)
    {
        if (_dayText != null)
    ...
    private void ApplyMaid(in DungeonCafeHudSnapshot snapshot)
    {
        if (_maidRoot != null)
    ...
    private void ApplyMonster(in DungeonCafeHudSnapshot snapshot)
    {
    ...
    private bool ValidateRefs()
    {
        ...
        if (missing.Length > 0)
        {
            Debug.LogWarning($"[DungeonCafeStatusOverlay] Missing refs:\n{missing}", this);
            return false;
        }
