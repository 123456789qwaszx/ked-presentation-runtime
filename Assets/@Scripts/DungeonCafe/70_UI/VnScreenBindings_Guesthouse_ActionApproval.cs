...
public sealed partial class VnScreenBindings
{
    ...
    public async YarnTask<ApprovalResponseV3> RequestApprovalAsync(ApprovalRequestV3 request)
    {
        ...
        RefreshGuesthouseHud(request.Session, "접객 중");
        ...
        return new ApprovalResponseV3(_pendingApprovalIndex, _pendingApprovalAbilities);
    }
    ...
    private void OpenActionApprovalPanel(ApprovalRequestV3 request)
    {
