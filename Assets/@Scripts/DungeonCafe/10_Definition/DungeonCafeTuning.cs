...
/// 캘린더/개체 풀 같은 '콘텐츠'는 DungeonCafeContentDB 쪽이고, 여기는 '숫자'만 둔다.
/// </summary>
public sealed class DungeonCafeTuning
{
    // ---- 게이지 (§1, §3) ----
    ...
    public static DungeonCafeTuning CreateStandard()
    {
