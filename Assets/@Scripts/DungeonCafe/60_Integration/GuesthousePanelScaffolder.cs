...
/// </summary>
public static class GuesthousePanelScaffolder
{
    ...
    private static void CreateAll()
    {
        ...
        Debug.LogWarning(
            "[GuesthousePanelScaffolder] 패널 10종 생성 완료. "
        ...
        where TRefs : struct, Enum
    {
        ...
        if (root == null)
        {
            ...
            Undo.RegisterCreatedObjectUndo(root, "Create Guesthouse Panel");
        }
    ...
    private static GameObject ResolveParent()
    {
        ...
        {
            Debug.LogWarning(
                "[GuesthousePanelScaffolder] 선택한 오브젝트가 Canvas 아래에 없다. "
