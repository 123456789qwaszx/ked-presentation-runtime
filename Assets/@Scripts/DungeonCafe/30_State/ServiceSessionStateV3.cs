...
public sealed class ServiceSessionStateV3
{
    public MaidStateV3 Maid { get; }
    public MonsterProfileV3 Monster { get; }
    ...
    public ServiceSessionStateV3(MaidStateV3 maid, MonsterProfileV3 monster, SpeciesProtocolV3 protocol)
    {
