...
public static class VNStoryGraphViewModelBuilder
{
        ...
        VNStoryGraphConditionSet conditionSet)
    {
        ...
        vm.visible = Evaluate(conditionSet, link.visibleConditionKey);
        vm.unlocked = Evaluate(conditionSet, link.unlockConditionKey);
        ...
        Dictionary<string, AttachmentIncomingState> result)
    {
        ...
        bool visible = Evaluate(conditionSet, link.visibleConditionKey);
        bool unlocked = Evaluate(conditionSet, link.unlockConditionKey);
        ...
        string conditionKey)
    {
        ...
        return conditionSet.Evaluate(conditionKey);
    }
