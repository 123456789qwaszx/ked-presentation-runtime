...
public sealed class VNOptionSelectionDecision
{
    ...
    public bool ShouldRecordedChoiceDuringSeek { get; private set; }
    ...
    public static VNOptionSelectionDecision ReplayRecordedChoiceDuringSeek()
    {
        return new VNOptionSelectionDecision
        {
            ShouldRecordedChoiceDuringSeek = true,
        };
    }
