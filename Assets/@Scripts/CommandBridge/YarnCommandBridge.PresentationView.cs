...
public sealed partial class YarnCommandBridge
{
    public void RegisterPresentationCommands()
    {
        ...
        _dialogueRunner.AddCommandHandler<string, float, float, float>("p_move_by",
            EnqueueMoveByPresentationTargetSpec);
        _dialogueRunner.AddCommandHandler<string, float, float, float>("p_move_to",
            EnqueueMoveToPresentationTargetSpec);
        _dialogueRunner.AddCommandHandler<string, float, float>("p_scale_to",
            EnqueueScaleToPresentationTargetUniformSpec);
        _dialogueRunner.AddCommandHandler<string, float, float, float, float>("p_scale_to_xyz",
            EnqueueScaleToPresentationTargetXYZSpec);
        _dialogueRunner.AddCommandHandler<string, float, float, float, float>("p_rotate_to",
            EnqueueRotateToPresentationTargetSpec);
        _dialogueRunner.AddCommandHandler<string, string, float, float>("p_slide_in",
            EnqueueSlideInPresentationTargetSpec);
