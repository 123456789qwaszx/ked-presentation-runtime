...
namespace Ked.Presentation.Sync
{
    ...
    public sealed class PresentationLaneState
    {
        ...
        private readonly ILaneRunner _runner;
        ...
        public bool IsDialogueRunning => _runner.IsRunning;
        ...
        public PresentationLaneState(ILaneRunner runner)
        {
            _runner = runner;
        }

        public void StartDialogue(string nodeName) => _runner.Start(nodeName);
        public Task StopDialogueAsync() => _runner.StopAsync();
